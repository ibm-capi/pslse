...
#define PSLSE_QUERY        0x01
#define PSLSE_ATTACH       0x02
#define PSLSE_DETACH       0x03
#define PSLSE_MEMORY_READ  0x04
#define PSLSE_MEMORY_WRITE 0x05
#define PSLSE_MEMORY_TOUCH 0x06
#define PSLSE_MEM_SUCCESS  0x07
#define PSLSE_MEM_FAILURE  0x08
#define PSLSE_MMIO_MAP     0x09
#define PSLSE_MMIO_READ64  0x0A
#define PSLSE_MMIO_WRITE64 0x0B
#define PSLSE_MMIO_READ32  0x0C
#define PSLSE_MMIO_WRITE32 0x0D
#define PSLSE_MMIO_ACK     0x0E
#define PSLSE_MMIO_FAIL    0x0F
#define PSLSE_INTERRUPT    0x10
