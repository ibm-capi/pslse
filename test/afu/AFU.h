...
class AFU
{
  private:
    ...
    uint64_t mmio_regs[3];	// MMIO registers starting from address 0x200
  ...
  public:
    /* constructor sets up descriptor from config file, establishes server
     * socket connection and waits for client to connect */
